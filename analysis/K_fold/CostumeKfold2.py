...
for model_name, model in models.items():
    ...
    for fold_index, (train_idx, test_idx) in enumerate(kf.split(X), 1):
        ...
        fold_metrics.append({"Fold": fold_index, "Precision": prec, "F1-Score": f1})
    ...
    # Identify best fold (by Precision now)
    best_fold_idx = metrics_df["Precision"].idxmax()
...
print(f"✅ K-Fold results and summary added to '{excel_path}' with sheets for LGBC, KNNC, and Model_Summary.")
