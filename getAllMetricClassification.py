...
# average_precision_score
cm = get_confusion_matrix_values(y, predictData, [0, 1, 2, 3, 4])
...
csi = calculate_csi(cm, [0, 1, 2, 3, 4])
hss = calculate_hss(cm)
fb = calculate_fb(cm, [0, 1, 2, 3, 4])
far = calculate_far(cm, [0, 1, 2, 3, 4])
pod = calculate_pod(cm, [0, 1, 2, 3, 4])
acc_balance_list = calculate_acc_balance(cm, [0, 1, 2, 3, 4])
