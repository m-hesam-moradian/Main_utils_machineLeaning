...
# Fold	R2	RMSE
# 1	-101.1503869	1.422730097
# 2	-31.29056669	0.832491586
# 3	-2.914640502	0.277510635
# 4	-2.793420327	0.283827057
# 5	-7.54532078	0.416227055

data = {
    "Fold": [1, 2, 3, 4, 5],
    "R2": [-101.1503869, -31.29056669, -2.914640502, -2.793420327, -7.54532078],
    "RMSE": [1.422730097, 0.832491586, 0.277510635, 0.283827057, 0.416227055],
}

# Reference overall metrics to align with first r2 second rmse
# example :
# 0.905793298	0.088691556 
# ref_r2 = 0.905793298
# ref_rmse = 0.088691556

# real data :
# 0.843569444	2.56335948
