...
model = LinearDiscriminantAnalysis(
    solver="eigen",  # Default: Singular Value Decomposition
    shrinkage=0.338,  # Default: No shrinkage for 'svd'
    priors=[0.938,0.401],  # Default: Priors estimated from class frequencies
