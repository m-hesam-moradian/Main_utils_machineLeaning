...
df = pd.read_excel(r"C:\Users\Sam\Desktop\ML\task\BMM-EI. No.22-Data.xlsx", sheet_name="Data_after_KFold_ENR")
y = df["Renewable Availability Index"].astype(float)
X = pd.get_dummies(df.drop(columns=["Renewable Availability Index"]), drop_first=True)
