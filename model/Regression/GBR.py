import pandas as pd
from sklearn.ensemble import GradientBoostingRegressor  # Swapped from XGBoost
from sklearn.metrics import mean_absolute_error, mean_squared_error, r2_score

# --- Load reordered data for GBR ---
...
# --- Define and train GBR model ---
model = GradientBoostingRegressor(
        n_estimators=428,
        learning_rate=0.085034018598665774,
        max_depth=3,
        # random_state=42
